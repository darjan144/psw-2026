...
public class SendProblemToReviewCommandHandler : IRequestHandler<SendProblemToReviewCommand, ProblemDto>
{
    private readonly IProblemRepository _problemRepository;
    private readonly ITourRepository _tourRepository;
    private readonly IUnitOfWork _unitOfWork;

    public SendProblemToReviewCommandHandler(IProblemRepository problemRepository, ITourRepository tourRepository, IUnitOfWork unitOfWork)
    {
    ...
    public async Task<ProblemDto> Handle(SendProblemToReviewCommand command, CancellationToken cancellationToken)
    {
